...
export const BRIDGE_VERSION  = '5.1.1'
...
export const BRIDGE_EXE_URL  = `https://github.com/albertosuarezgutierrez-gif/ia.rest/releases/download/${BRIDGE_RELEASE}/${BRIDGE_EXE_NAME}`
